...
// repeated .fixbug.User friend_list = 2;
inline int GetFriendListReponse::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendListReponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListReponse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListReponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListReponse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListReponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListReponse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendListReponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListReponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListReponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListReponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendListReponse::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListReponse.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListReponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListReponse.friend_list)
  return friend_list_;
}
